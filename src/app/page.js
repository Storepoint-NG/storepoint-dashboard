    ...
    <div>
      <div className="container flex flex-col mx-auto bg-white">
        ...
        <div className="grid w-full grid-cols-1 my-auto mt-12 mb-8 md:grid-cols-2 xl:gap-14 md:gap-5">
          <div className="flex flex-col justify-center col-span-1 text-center lg:text-start">
            <div className="hidden items-center justify-center mb-4 lg:justify-normal">
              <img
                className="h-5"
            ...
            <h1 className="mb-8 text-4xl font-extrabold leading-tight lg:text-6xl text-dark-grey-900">
              Own a website and start selling online in less than 5mins
            </h1>
            <p className="mb-6 text-base font-normal leading-7 lg:w-3/4 text-grey-900">
              Ready to launch your online store without spending big or waiting
              forever? Get the fastest, most responsive, and trendiest solution
              now. Seriously.
            </p>
            <div className="flex flex-col items-center gap-4 lg:flex-row">
              <Link href="/signup">
                <button className="flex items-center py-4 text-sm font-semibold text-white px-7 bg-indigo-600 hover:bg-indigo-500 ffocus:ring focus:ring-gray-300 focus:ring-opacity-80 transition duration-300 rounded-lg">
                  Get started now
                </button>
              </Link>
            </div>
          </div>
          <div className="bg-purple justify-end hidden col-span-1 md:flex">
            <img
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Setup up your store in less than 5mins. Add products and share
                  store link with customers.
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Receive payments when customers shop from your store using
                  secured payment gateways and alternatives.
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  We&apos;ve got the best partners to help you handle logistics
                  and delivery from your store to your customers door-step.
                </dd>
              </div>
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  Manage your store assets. Track sales, orders and products.
                </dd>
              </div>
            </dl>
          </div>
      ...
      <section className="hidden bg-white dark:bg-gray-900">
        <div className="container mx-auto px-6 py-10">
          ...
          <div className="mx-auto mt-6 flex justify-center">
            ...
            <span className="mx-1 inline-block h-1 w-3 rounded-full bg-indigo-500"></span>
      ...
      <section className="hidden bg-white dark:bg-gray-900">
        <div className="container mx-auto px-6 py-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-gray-500 dark:text-gray-300 xl:mt-6"></p>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:mt-12 xl:gap-12">
            <div className="w-full space-y-8 rounded-lg border border-gray-100 p-8 text-center dark:border-gray-700">
              ...
              <Link href="/signup">
                <button className="mt-10 w-full transform rounded-md bg-indigo-600 px-4 py-2 capitalize tracking-wide text-white transition-colors duration-300 hover:bg-indigo-500 focus:bg-indigo-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                  Start Now
                </button>
              </Link>
            </div>
          ...
          <div className="mt-12 space-y-8">
            ...
            <div className="rounded-lg border-2 border-gray-100 dark:border-gray-700">
              <button className="flex w-full items-center justify-between p-8">
                ...
                <span className="rounded-full bg-indigo-500 text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
                    fill="none"
      ...
      <div class="flex flex-col justify-center items-center  my-10">
        <div className="flex bg-indigo-600   w-full flex-row rounded-lg bg-cover px-[30px] py-[30px] md:px-[64px] md:py-[56px] max-w-[95%] xl:max-w-[800px] ">
          <div className="w-fit ">
            <h4 className="mb-[14px] max-w-full text-3xl font-bold text-white md:w-[64%] md:text-3xl md:leading-[42px] ">
              Build your online store now
            </h4>
            <p className="mb-[40px] max-w-full text-base font-medium text-[#E3DAFF] md:w-[60%]">
              Join thousands of business owners taking their business online,
              where customers are spending their time.
            </p>

            <Link href="/signup">
              <button className="text-indigo-600 break-keep rounded-md bg-white px-10 py-4 text-center text-base font-semibold h-fit transition duration-200 hover:!bg-white/80 active:!bg-white/70">
                Get Started
              </button>
            </Link>
          </div>
